...
definition: >
  ...
  and including the closure date — excluding dates in the study's assigned
  holiday calendar (calendars/*.yaml, ADR-0016); a study with no calendar
  counts weekdays only. v1.0 measured calendar days; v1.1 counted weekdays
